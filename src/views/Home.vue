<template>
    <main id="main" class="main">
        <!-- VISUAL -->
        <section class="main-section main-section--visual visual">
            <div class = "light"></div>
                    ...
                    <li>
                        ...
                        <div class="timeline__panel">
                            ...
                            <div class="timeline__description">
                                - 웹 페이지 퍼블리싱 구축 및 유지보수 <br>
                                - vue.js 프레임 워크를 이용한 SPA 퍼블리싱 및 프론트 개발 <br>
                                기술스택: vue.js, scss, javascript(ES6), jQuery, html5/css3
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="timeline__image" style="background-color:#10B4B1">
                            E
                        </div>
                        <div class="timeline__panel">
                            <div class="timeline__heading">
                            ...
                            <div class="timeline__description">
                                교과서(다락원) 전자저작물 이러닝 제작 프로젝트 참여(프로토 제작 외) <br>
